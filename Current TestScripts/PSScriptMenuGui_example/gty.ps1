...
cls
$BeepList = @(
    @{ Pitch = 1059.274; Length = 150; };
    @{ Pitch = 1059.274; Length = 100; };
    @{ Pitch = 1188.995; Length = 250; };
    @{ Pitch = 1059.274; Length = 250; };
    @{ Pitch = 1413.961; Length = 250; };
    @{ Pitch = 1334.601; Length = 475; };

    @{ Pitch = 1059.274; Length = 150; };
    @{ Pitch = 1059.274; Length = 100; };
    @{ Pitch = 1188.995; Length = 250; };
    @{ Pitch = 1059.274; Length = 250; };
    @{ Pitch = 1587.117; Length = 250; };
    @{ Pitch = 1413.961; Length = 475; };
